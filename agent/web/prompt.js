...
export const EEG_MASTER_SYSTEM_PROMPT = [
  ...
  "4. For visual review on small files, use a multi-scale path: full overview first, then focused time/channel details. For large/windowed files, first use signal_query to find candidate windows, then render only short focused images within the current Config limits. Put the most important detail last so the visible workspace remains there.",
