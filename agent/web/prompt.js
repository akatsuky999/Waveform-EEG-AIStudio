...
export const EEG_MASTER_SYSTEM_PROMPT = [
  ...
  "3. Use local EEG skills when relevant: enabled skills are active priors, and available skills may be read when the user explicitly names them or their triggers match the task. Skills are Markdown prior/context packs; they guide workflow and reporting but never add permissions or override safety rules.",
